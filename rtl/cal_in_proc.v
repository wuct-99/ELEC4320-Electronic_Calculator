...
bcd_convert_bin in_num_a_convert (.clk(clk), .rst_n(rst_n), .in_digits(in_digits_a),.bin_output(in_num_a_bin));  
bcd_convert_bin in_num_b_convert (.clk(clk), .rst_n(rst_n), .in_digits(in_digits_b),.bin_output(in_num_b_bin));  
...
//input qualification
assign nxt_cal_stage_vld[0]   = mode_sw_final[0]  & ~(|mode_sw_final[1:10]) & num_chk_vld ;
assign nxt_cal_stage_vld[1]   = mode_sw_final[1]  & ~mode_sw_final[0] & ~(|mode_sw_final[2:10]) & num_chk_vld ;
assign nxt_cal_stage_vld[2]   = mode_sw_final[2]  & ~(|mode_sw_final[0:1]) & ~(|mode_sw_final[3:10]) & num_chk_vld ;
assign nxt_cal_stage_vld[3]   = mode_sw_final[3]  & ~(|mode_sw_final[0:2]) & ~(|mode_sw_final[4:10]) & num_chk_vld ;
assign nxt_cal_stage_vld[4]   = mode_sw_final[4]  & ~(|mode_sw_final[0:3]) & ~(|mode_sw_final[5:10]) & num_chk_vld & ~in_num_a_bin[15];
assign nxt_cal_stage_vld[5]   = mode_sw_final[5]  & ~(|mode_sw_final[0:4]) & ~(|mode_sw_final[6:10]) & num_chk_vld ;
assign nxt_cal_stage_vld[6]   = mode_sw_final[6]  & ~(|mode_sw_final[0:5]) & ~(|mode_sw_final[7:10]) & num_chk_vld ;
assign nxt_cal_stage_vld[7]   = mode_sw_final[7]  & ~(|mode_sw_final[0:6]) & ~(|mode_sw_final[8:10]) & num_chk_vld ;
assign nxt_cal_stage_vld[8]   = mode_sw_final[8]  & ~(|mode_sw_final[0:7]) & ~(|mode_sw_final[9:10]) & num_chk_vld & ~in_num_a_bin[15] & ~in_num_b_bin[15];
assign nxt_cal_stage_vld[9]   = mode_sw_final[9]  & ~(|mode_sw_final[0:8]) & ~mode_sw_final[10] & num_chk_vld ;
assign nxt_cal_stage_vld[10]  = mode_sw_final[10] & ~(|mode_sw_final[0:9]) & num_chk_vld ;
...
dffre #(11) cal_stage_vld_ff (.clk(clk), .rst_n(rst_n), .en(num_chk_vld), .d(nxt_cal_stage_vld), .q(cal_stage_vld));
